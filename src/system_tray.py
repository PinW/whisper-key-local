    ...
    def _create_menu(self):
        ...
        try:
            ...
            model_menu_items = [
                ...
                pystray.MenuItem("Tiny (English-only)", lambda icon, item: self._select_model("tiny.en"), radio=True, checked=lambda item: is_current_model("tiny.en")),
                pystray.MenuItem("Base (English-only)", lambda icon, item: self._select_model("base.en"), radio=True, checked=lambda item: is_current_model("base.en")),
                pystray.MenuItem("Small (English-only)", lambda icon, item: self._select_model("small.en"), radio=True, checked=lambda item: is_current_model("small.en"))
            ]
